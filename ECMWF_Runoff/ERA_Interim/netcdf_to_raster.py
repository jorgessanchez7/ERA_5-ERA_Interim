...
#Work Folder
folder_Output = "Y:\\ECMWF_Runoff\\ERA_Interim\\Daily_GeoTIFF"
...
for year in years:
	folder_Input = "Y:\\ERA_Interim_35yr_data\\era_data\\erai_runoff_1980to2014.tar.gz\\{0}_erai_runoff".format(year)
	for month in months:
		for day in days:
