...
#Work Folder
folder_Input = "/Volumes/files/ECMWF_Runoff/ERA_Interim/Daily_GeoTIFF"
folder_Output = "/Volumes/files/ECMWF_Runoff/ERA_Interim/Daily_GeoTIFF_Resampled"
...
for year in years:
    for month in months:
        for day in days:
            ...
            inputfile =  Path(folder_Input + "/" + year + "/" + month + "/" + year + "-" + month + "-" + day + ".tif")
            if inputfile.exists():
                print('si hay archivo')
                inputfile = folder_Input + "/" + year + "/" + month + "/" + year + "-" + month + "-" + day + ".tif"
            else:
                print('segun esto no hay archivo, que vaina rara')
                inputfile = folder_Input + "/" + year + "/" + month + "/" + year + "-" + month + "-" + day + ".tif"
