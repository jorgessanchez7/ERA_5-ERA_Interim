...
# Folders de trabajo
FldOut = "/Volumes/files/ECMWF_Runoff/ERA_Interim/Daily_GeoTIFF_Clipped/"
...
for region in regions:
    ...
    for time in time_series:
        ...
        # ERA-Interim
        input_raster = '/Volumes/files/ECMWF_Runoff/ERA_Interim/Daily_GeoTIFF/{0}/{1}/{2}-{3}-{4}.tif'.format(YYYY, MM, YYYY, MM, DD)
