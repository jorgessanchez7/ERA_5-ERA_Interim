...
#Work Folder
folder_ERA5 = "Y:\\ECMWF_Runoff\\ERA_5\\Daily_GeoTIFF_Resampled"
folder_ERAI = "Y:\\ECMWF_Runoff\\ERA_Interim\\Daily_GeoTIFF_Resampled"
folder_output = "Y:\\ECMWF_Runoff\\Difference"
...
for year in years:
	for month in months:
		for day in days:
			...
			minuendo = folder_ERAI + "\\" + "\\" + year + "\\" + month + "\\" + year + "-" + month + "-" + day + ".tif"

			sustraendo = folder_ERA5 + "\\" + "\\" + year + "\\" + month + "\\" + year + "-" + month + "-" + day + ".tif"
