...
#Work Folder
folder_Input = "Y:\\ECMWF_Runoff\\ERA_5\\Daily_GeoTIFF_Filled"
folder_Output = "Y:\\ECMWF_Runoff\\ERA_5\\Daily_GeoTIFF_Resampled"
...
for year in years:
	for month in months:
		for day in days:
			...
			try:
				FileSnap = 'Y:\\ECMWF_Runoff\\ERA_5\\Daily_GeoTIFF_Filled\\{0}\\{1}\\{0}-{1}-{2}.tif'.format(year, month, day)
			except:
				FileSnap = 'Y:\\ECMWF_Runoff\\ERA_5\\Daily_GeoTIFF_Filled\\{0}\\{1}\\1980-01-01.tif'.format(year, month, day)
			...
			arcpy.env.extent = arcpy.Extent(-0.125, -90.125, 360.125, 90.125)
