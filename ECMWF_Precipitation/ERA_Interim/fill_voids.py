...
folder_Output = "Y:\\ECMWF_Precipitation\\ERA_Interim\\Daily_GeoTIFF_Filled"
...
for year in years:
	for month in months:
		for day in days:
			...
			try:
				FileSnap = 'Y:\\ECMWF_Runoff\\ERA_Interim\\Daily_GeoTIFF\\{0}\\{1}\\{0}-{1}-{2}.tif'.format(year, month, day)
			except:
				FileSnap = 'Y:\\ECMWF_Runoff\\ERA_Interim\\Daily_GeoTIFF\\{0}\\{1}\\1980-01-01.tif'.format(year, month, day)
