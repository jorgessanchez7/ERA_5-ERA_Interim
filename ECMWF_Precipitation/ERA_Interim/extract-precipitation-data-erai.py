...
for region in regions:
    ...
    for point_x, point_y, point in zip(POINT_Xs, POINT_Ys, POINTs):
        ...
        for time in time_series:
            ...
            raster_filename = '/Users/ElkiGio/Desktop/ERA_5-ERA_Interim/ECMWF_Precipitation/ERA_Interim/Daily_GeoTIFF_Resampled/{0}/{1}/{2}-{3}-{4}.tif'.format(YYYY, MM, YYYY, MM, DD)
        ...
        #values_df.to_csv('/home/water/mount_to_container/NASdrive/ECMWF_Precipitation/Time_Series/ERA_5/{0}/{1}.csv'.format(region, point), encoding='utf-8')
        '''
        ...
        # values_df.to_csv('/Users/ElkiGio/Desktop/ERA_5-ERA_Interim/ECMWF_Precipitation/ERA_Interim/{0}/{1}.csv'.format(region, point))
        #values_df.to_csv('/home/water/mount_to_container/NASdrive/ECMWF_Precipitation/Time_Series/ERA_Interim/{0}/{1}.csv'.format(region, point), encoding='utf-8')
