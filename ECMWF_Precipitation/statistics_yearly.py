...
for ano in listaano:
	...
	mean.save(r"Y:/ECMWF_Precipitation/Difference/yearly/{0}.tif".format(ano))
	...
	sum.save(r"Y:/ECMWF_Precipitation/ERA_5/Daily_GeoTIFF/yearly/{0}.tif".format(ano))
	...
	#Run Cell Statistics
	sum = arcpy.sa.CellStatistics(rasters, statistics_type = "SUM")
	sum.save(r"Y:/ECMWF_Precipitation/ERA_Interim/Daily_GeoTIFF_Resampled/yearly/{0}.tif".format(ano))
