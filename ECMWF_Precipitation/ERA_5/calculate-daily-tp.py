...
for year in years:
	for month in months:
		for day in days:
			...
			#f_in = '/home/me/files/ECMWF_Precipitation/ERA_5/Hourly/{0}.nc'.format(year)
			f_in = '/Volumes/files/ECMWF_Precipitation/ERA_5/Hourly/{0}.nc'.format(year)
			#f_in = 'Y:\ECMWF_Precipitation\ERA_5\Hourly\{0}.nc'.format(year)
			#f_out = '/home/me/files/ECMWF_Precipitation/ERA_5/Daily/{0}-{1}-{2}.nc'.format(year, month, day)
			f_out = '/Volumes/files/ECMWF_Precipitation/ERA_5/Daily/{0}-{1}-{2}.nc'.format(year, month, day)
			#f_out = 'Y:\ECMWF_Precipitation\ERA_5\Daily\{0}-{1}-{2}.nc'.format(year, month, day)
