...
#Work Folder
folder_Input = "Y:\\ECMWF_Precipitation\\ERA_5\\Daily"
folder_Output = "Y:\\ECMWF_Precipitation\\ERA_5\\Daily_GeoTIFF"
...
for year in years:
	for month in months:
		for day in days:
			...
			tifOutput = '{0}\\{1}\\{2}\\{1}-{2}-{3}.tif'.format(folder_Output, year, month, day)
			arcpy.MakeNetCDFRasterLayer_md(fileInput, "tp", "longitude", "latitude", fileOutput, "time", "#", "BY_VALUE")
			# Export to GeoTiFF
